            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-4 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-800 placeholder-slate-400"
                            />
                    ...
                    <div className="mt-6 flex items-center justify-between pt-4 border-t border-slate-100">
                        <p className="text-sm text-slate-500">
                            عرض <span className="font-bold text-slate-900">{filteredPharmacies.length}</span> صيدلية
                        </p>
                        <button
                            onClick={() => {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 order-2 lg:order-1">
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 flex flex-col h-[600px]">
                            <div className="p-4 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                                <h3 className="font-bold text-slate-800">قائمة الصيدليات</h3>
                            </div>
                    ...
                    <div className="lg:col-span-2 order-1 lg:order-2">
                        <div className="bg-slate-100 rounded-2xl shadow-sm border border-slate-200 overflow-hidden h-[600px] relative">
                            {loading ? (
                                ...
                                >
                                    ...
                                    {filteredPharmacies.map(pharmacy => (
                                        ...
                                        >
                                            <Popup>
                                                <div className="p-1 min-w-[200px] font-sans text-right" dir="rtl">
                                                    <h3 className="font-bold text-base text-slate-900 mb-1">{pharmacy.name}</h3>
                                                    {pharmacy.neighborhood && (
                                                        <span className="inline-block px-1.5 py-0.5 bg-slate-100 text-slate-600 text-xs rounded border border-slate-200 mb-2">
                                                            {pharmacy.neighborhood.name}
                                                        </span>
                                                    )}
                                                    ...
                                                    {pharmacy.phone && (
                                                        <p className="text-xs text-slate-600 mb-3 font-mono" dir="ltr">
                                                            📞 {pharmacy.phone}
                                                        </p>
                                                    )}
                                                    <a
                                                        ...
                                                        className="block w-full text-center py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded transition-colors"
                                                    >
                                                        عرض في خرائط Google
                                                    </a>
                                                </div>
